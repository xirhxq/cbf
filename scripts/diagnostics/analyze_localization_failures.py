...
def _protocol_record(max_examples_per_bucket: int) -> dict:
    return {
        "failure_class_predicates": [
            ...
            {"class": "upstream_unavailable", "attempt_status": "invalid", "attempt_failure_reason": _UPSTREAM_UNAVAILABLE_REASON},
            {"class": "invalid_input_or_numeric", "attempt_status": "invalid", "attempt_failure_reason": {"not_equal": _UPSTREAM_UNAVAILABLE_REASON}},
            {"class": "wnls_nonconvergence", "attempt_status": "failed", "attempt_failure_reason": _WNLS_NONCONVERGENCE_REASON},
            {"class": "other_failed", "attempt_status": "failed", "attempt_failure_reason": {"not_equal": _WNLS_NONCONVERGENCE_REASON}},
        ],
        "bin_edges": {
            ...
            "reference_count": {
                ...
                "ten_or_more": {"lower": 10, "upper": None, "lower_closed": True, "upper_closed": False},
            },
        ...
        "bootstrap": {
            ...
            "minimum_estimable_resamples": math.ceil(0.95 * _BOOTSTRAP_RESAMPLES),
        ...
        "operational_limits": {
            "start_available_bytes": START_BYTES,
            "live_available_bytes": HARD_FLOOR_BYTES,
            "output_root_allocated_bytes": OUTPUT_ROOT_CAP_BYTES,
            "incomplete_run_allocated_bytes": _INCOMPLETE_OUTPUT_CAP_BYTES,
            "live_check_interval_rows": _LIVE_CHECK_INTERVAL_ROWS,
        },
